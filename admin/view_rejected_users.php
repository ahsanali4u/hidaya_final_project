...
<style>
   ...
   <?php
      ...
      $database->query = "SELECT user_id,first_name,last_name,user_image,email,gender,date_of_birth,u.is_active,is_approved 
                          FROM user u INNER JOIN role r ON u.role_id = r.role_id WHERE u.role_id = '2' AND is_approved = 'Rejected' ORDER BY u.user_id DESC";
